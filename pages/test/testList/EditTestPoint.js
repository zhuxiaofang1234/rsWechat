...
new Page({
  ...
  fromType: function() {
    ...
    switch (TestModeCode) {
      case 'TQ':
      case 'TZ':
        var item = { 'code': 'pileAxis','name':'轴线位置','value':''};
        pileItems = [
          { 'code': 'pileAxis', 'name': '轴线位置', 'value': '' },
          { 'code': 'pileBearing', 'name': '设计地基承载力特征值(kPa)', 'value': ''},
          { 'code': 'height1', 'name': '检测起始试验标高(m)', 'value': '' },
          { 'code': 'height2', 'name': '设计基底标高(m)', 'value': '' }
          ]
      break;
      case 'ZX':
      case 'ZG':
      ...
      case 'ZY':
        pileItems = [
          { 'code': 'pileNo', 'name': '桩号', 'value': '' },
          { 'code': 'tubeNumber', 'name': '孔数', 'value': '' },
          { 'code': 'pileDiameter', 'name': '桩径(mm)', 'value': '' },
          { 'code': 'pileType', 'name': '桩型', 'value': '' },
          { 'code': 'pileLength', 'name': '桩长(m)', 'value': '' },
          { 'code': 'pileAxis', 'name': '轴线位置', 'value': '' },
          { 'code': 'pileDate', 'name': '成桩日期', 'value': '' },
          { 'code': 'powerLevel', 'name': '设计强度', 'value': '' },
          { 'code': 'tempStr4', 'name': '允许沉渣厚度(cm)', 'value': '' },
          { 'code': 'pileBearing', 'name': '单桩承载力特征值(kN)', 'value': '' },
          { 'code': 'forceLayer', 'name': '设计桩端持力层', 'value': '' },
        ]
    } 
   return  pileItems
  },
